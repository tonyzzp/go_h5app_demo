...
const goappEnv = {"GOAPP_INTERNAL_URLS":"null","GOAPP_ROOT_PREFIX":"/go_h5app_demo","GOAPP_STATIC_RESOURCES_URL":"/go_h5app_demo","GOAPP_VERSION":"90d080e601b0d77aae34a85c3ac269b069e8abc0"};
...
async function goappInitWebAssembly() {
  ...
  try {
    ...
    const wasm = await instantiateStreaming(
      fetch("/go_h5app_demo/web/app.wasm"),
      go.importObject
    );
